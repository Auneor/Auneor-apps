...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:variable name="height_increment">3.9</xsl:variable>
	<xsl:variable name="width_increment">6.8</xsl:variable>
	<xsl:variable name="frame_height">3.81cm</xsl:variable>
	<xsl:variable name="frame_width">6.35cm</xsl:variable>
	...
	<xsl:template match="address" mode="story">
		<para style="nospace"><xsl:value-of select="company-parent-title"/><xsl:text> </xsl:text><xsl:value-of select="company-parent-name"/></para>
